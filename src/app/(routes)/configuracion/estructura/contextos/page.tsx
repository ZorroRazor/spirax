...
enum ContextStatus { PLANNED = "Planificado", ACTIVE = "Activo", CLOSED = "Cerrado" }
...
type OperatingContext = {
  ...
  type: ContextType;
  name: string;
  hierarchy: string; // "Planta Norte > Área Producción"
  startAt: string;
  endAt?: string;
...
const MOCK_CONTEXTS: OperatingContext[] = [
  ...
  { id: 6, contextUUID: "CO-2026-006", type: ContextType.TARIFARIO, name: "Periodo Valle — Tarifa Discriminación Horaria", hierarchy: "Planta Norte", startAt: daysAgo(0, 0, 0), endAt: daysAhead(0, 7, 59), status: ContextStatus.ACTIVE, metadata: { tariff: "Valle" } },
